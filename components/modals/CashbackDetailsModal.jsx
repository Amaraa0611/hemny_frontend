        ...
        <div className="p-4 sm:p-6 h-full w-full flex flex-col max-h-[90vh] sm:max-h-[80vh] overflow-y-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-[65%] space-y-6">
              {/* Offer Period and Payment Org - Side by side on desktop */}
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                {paymentOrg && (
                  <div className="flex-1 bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Cashback олгох байгууллага</h3>
                    <div className="flex items-center space-x-3">
                      <div className="relative">
                        <img
                          src={getPaymentOrgLogo()}
                          alt={paymentOrg.org_name}
                      ...
                      <p className="text-base font-medium text-gray-900">{paymentOrg.org_name}</p>
                    </div>
                  </div>
                )}
              </div>
